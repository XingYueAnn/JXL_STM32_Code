...
#define LCD_CS_Clr()   GPIO_ResetBits(GPIOB,GPIO_Pin_4)//CS
#define LCD_CS_Set()   GPIO_SetBits(GPIOB,GPIO_Pin_4)

#define LCD_BLK_Clr()  GPIO_ResetBits(GPIOB,GPIO_Pin_5)//BLK
